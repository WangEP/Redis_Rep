...
#define CLUSTER_NODE_HG_MAIN 2048 /* this flg shows node in HG and it's a main node */
...
typedef struct clusterState {
    ...
    double avg_hot_point_for_cluster[3];
